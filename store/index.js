...
export const featuredfunds = [{
  title: 'Fund Name 1',
  text: 'Fund #1 This card has supporting text below as a natural lead-in to additional content.',
  image: 'https://via.placeholder.com/350x150'
}, {
  title: 'Fund Name 2',
  text: 'Fund #2 This card has supporting text below as a natural lead-in to additional content.',
  image: 'https://via.placeholder.com/350x150'
}, {
  title: 'Fund Name 3',
  text: 'Fund #3 This card has supporting text below as a natural lead-in to additional content.',
  image: 'https://via.placeholder.com/350x150'
}];
